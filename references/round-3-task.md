...
THEN, read ALL Round 2 cross-attack files from {{INPUT_DIR}}/ — use Glob to list every .md file, then Read each one.
...
OUTPUT — Write your defenses to {{OUTPUT_PATH}} using the Write tool. Use this EXACT format (the round-4 planner reads this to distill surviving insights):
