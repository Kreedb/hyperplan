...
Write the full plan to {{CACHE_PATH}}/phase_4/plan.md using the Write tool. Return a one-line confirmation ('Plan written to {{CACHE_PATH}}/phase_4/plan.md') as your final message. Use this EXACT format:
