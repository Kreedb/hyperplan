...
RETURN the full plan as your output. Use this EXACT format (the Lead writes this to {{CACHE_DIR}}/phase_4/plan.md, presents it to the user for confirmation, then parses it to drive Phase 5 execution):
